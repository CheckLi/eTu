...
//            this.isForceUpdate = false;
        ...
        public Builder setOnlayUpdata(boolean onlayUpdata){
            params.isOnlyUpdata=onlayUpdata;
            return this;
        }
...
//        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.isOnlyUpdata ? (byte) 1 : (byte) 0);
    }
    ...
    protected VersionParams(Parcel in) {
        ...
        this.isOnlyUpdata = in.readByte() != 0;
    }
