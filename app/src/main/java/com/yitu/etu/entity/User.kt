...
data class UserInfo(
		@SerializedName("id") val id: Int, //31
		...
		@SerializedName("map_id") val mapId: Int, //0
		@SerializedName("balance") val balance: String, //0.00
		@SerializedName("safecount") val safecount: Int, //0
		@SerializedName("status") val status: Int, //1
		@SerializedName("is_circle") val isCircle: Int, //0
		@SerializedName("is_del") val isDel: Int, //0
		@SerializedName("created") val created: Int, //1512573048
		@SerializedName("updated") val updated: Int, //1512573139
		@SerializedName("ispaypwd") val ispaypwd: Int, //0
